      ...
      <Table>
        <TableHeader className="bg-muted/40">
          <TableRow className="hover:bg-transparent border-b border-border">
                        ...
                        <div className="space-y-3">
                            <div className="space-y-2">
                                <div className="flex items-center space-x-2.5">
                                    ...
                                    />
                                    <Label htmlFor="admin-all" className="font-normal cursor-pointer">All</Label>
                                </div>
                                ...
                                {availableAdminOptions.hasAdmin && (
                                    <div className="flex items-center space-x-2.5">
                                        ...
                                        />
                                        <Label htmlFor="admin-yes" className="font-normal cursor-pointer">Admin Only</Label>
                                    </div>
                                )}
                                ...
                                {availableAdminOptions.hasNonAdmin && (
                                    <div className="flex items-center space-x-2.5">
                                        ...
                                        />
                                        <Label htmlFor="admin-no" className="font-normal cursor-pointer">Non-Admin Only</Label>
                                    </div>
                                )}
            ...
            <TableHead className="font-medium text-muted-foreground cursor-pointer hover:text-foreground transition-colors" onClick={() => handleSort('lastRecordDate')}>Last Record</TableHead>
            <TableHead className="font-medium text-muted-foreground cursor-pointer hover:text-foreground transition-colors" onClick={() => handleSort('lockedUntil')}>Locked Until</TableHead>
            <TableHead className="font-medium text-muted-foreground cursor-pointer hover:text-foreground transition-colors" onClick={() => handleSort('titlePrefix')}>Title Prefix</TableHead>
            <TableHead className="font-medium text-muted-foreground cursor-pointer hover:text-foreground transition-colors" onClick={() => handleSort('titleSuffix')}>Title Suffix</TableHead>
            ...
            <TableRow key={employee.id} className="group hover:bg-muted/30 transition-colors border-border">
              ...
              <TableCell>
                {employee.isAdmin ? (
                  ...
                  <Badge variant="secondary" className="font-normal text-muted-foreground">No</Badge>
                )}
              </TableCell>
              ...
              <TableCell>
                <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <Button variant="ghost" size="icon" onClick={() => onResetPassword?.(employee)} className="h-8 w-8 text-muted-foreground hover:text-foreground" title="Reset Password">
