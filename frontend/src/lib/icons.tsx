import { cn } from "@/lib/utils" // Import pre lepšiu prácu s triedami

// Typ pre props, ktoré môžu ikony prijať
...
export const Icons = {
  ...
  circle: ({ className, ...props }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="none"
  ...
  loader: ({ className, ...props }: IconProps) => (
    ...
    >
      <circle cx="12" cy="12" r="10" />
      <path d="M12 6a6 6 0 0 1 6 6" strokeDasharray="0 0" />
    </svg>
  ),
}